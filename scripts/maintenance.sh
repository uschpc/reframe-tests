...
tmux new-session -d -s rfm-npb-omp-mg "reframe -c tests/npb-omp-mg.py -p gcc-15.3.0 -J reservation=$res --distribute=all -r; bash"

# Run NPB CUDA LU test on all GPU nodes
tmux new-session -d -s rfm-npb-cuda-lu-cuda13 "reframe -c tests/npb-cuda-lu-cuda13.py -p gcc-15.3.0-cuda-13.0.3 -J reservation=$res --distribute=all -r; bash"
tmux new-session -d -s rfm-npb-cuda-lu-cuda12 "reframe -c tests/npb-cuda-lu-cuda12.py -p gcc-14.3.0-cuda-12.9.1 -J reservation=$res --distribute=all -r; bash"
