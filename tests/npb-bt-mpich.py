...
class NPB_BT_MPICH(rfm.RunOnlyRegressionTest):
    descr = 'NPB BT MPI benchmark using gcc/11.3.0 and mpich/4.0.2 with pmi2'
    valid_systems = [
        'discovery:main',
        'discovery:epyc-64',
        'discovery:gpu',
    ...
    sourcesdir = None
    executable = '/project/hpcroot/reframe2/resources/NPB/gcc-11.3.0/NPB3.4.2/NPB3.4-MPI-mpich-4.0.2/bin/bt.A.x'
    num_tasks = 4
