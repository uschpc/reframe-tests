...
@rfm.simple_test
class NPB_BT_MPICH(rfm.RunOnlyRegressionTest):
    def __init__(self):
        self.descr = 'NPB BT MPI benchmark using gcc/11.3.0 and mpich/4.0.2 with pmi2'
        self.valid_systems = [
            'discovery:main',
            'discovery:epyc-64',
            'endeavour:shared'
        ...
        self.executable = '/project/hpcroot/reframe2/resources/NPB/gcc-11.3.0/NPB3.4.2/NPB3.4-MPI-mpich-4.0.2/bin/bt.A.x'
        self.num_tasks = 4
