...
# Translated to CUDA
# This test is for CUDA 12 and supported GPU models
# Purpose of test
...
@rfm.simple_test
class npb_cuda_lu_cuda12(rfm.RunOnlyRegressionTest):
    ...
    reference = {
        ...
        "discovery:v100": {
            "Mop/s_total": (179000, -0.05, 0.05, "Mop/s")
        },
        "discovery:p100": {
        ...
        "endeavour:rtx5000": {
            "Mop/s_total": (75000, -0.05, 0.05, "Mop/s")
        },
        "laguna:l40s": {
            "Mop/s_total": (414000, -0.05, 0.05, "Mop/s")
        }
