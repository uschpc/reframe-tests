...
class IOR_scratch2(rfm.RunOnlyRegressionTest):
    descr = 'IOR benchmark for /scratch2 file system'
    tags = {
        'daily'
    }
    valid_systems = [
    ...
    sourcesdir = None
    executable = 'ior -vvv -t 4m -b 64m -s 16 -F -C -e -o /scratch2/$USER/reframe.tmp'
    num_tasks = 16
    ...
    reference = {
        '*': {
            'max_write_speed': (2000.00, -0.25, None, 'MiB/sec'),
            'max_read_speed': (4000.00, -0.25, None, 'MiB/sec')
        }
    }
