...
class IOR_scratch2(rfm.RunOnlyRegressionTest):
    def __init__(self):
        ...
        self.executable = 'ior -vvv -t 4m -b 64m -s 16 -F -C -e -o /scratch2/$USER/reframe.tmp'
        self.num_tasks = 16
        ...
        self.reference = {
            '*': {
                'max write speed': (2000.00, -0.25, None, 'MiB/sec'),
                'max read speed': (4000.00, -0.25, None, 'MiB/sec')
            }
        }
